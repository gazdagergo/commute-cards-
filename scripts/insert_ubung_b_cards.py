#!/usr/bin/env python3
"""
Insert Übung B learning cards into the database.
Run with: fly postgres connect -a sociology-learning-pwa-db < scripts/insert_ubung_b_cards.sql
Or via Python with DATABASE_URL set.
"""
...
cards = [
    ...
    # Card 6: Fill-in-the-blank - Journal article elements
    {
        "semantic_description": "Übung B: Fill in the blank - key element needed to find a journal article in library catalog",
        "course_task_ref": "ubung-b-task2",
        "card_html": '''<div x-data="cardResponse()" class="p-4">
    <div x-data="{ answer: '' }">
    ...
    # Card 7: Fill-in-the-blank - Strategic reading
    {
        "semantic_description": "Übung B: Fill in the blank - strategic reading technique for research articles",
        "course_task_ref": "ubung-b-task3",
        "card_html": '''<div x-data="cardResponse()" class="p-4">
    <div x-data="{ answer: '' }">
        <p class="text-gray-600 text-sm mb-2">Ergänze den fehlenden Begriff</p>
    ...
    # Card 8: Free text - Explain heuristics in research
    {
        "semantic_description": "Übung B: Explain in own words how heuristics are used in research methodology",
        "course_task_ref": "ubung-b-task4",
        "card_html": '''<div x-data="cardResponse()" class="p-4">
    <div x-data="{ answer: '' }">
    ...
    # Card 9: Free text - Summarize research findings
    {
        "semantic_description": "Übung B: Practice summarizing research findings in clear, concise language",
        "course_task_ref": "ubung-b-task3",
        "card_html": '''<div x-data="cardResponse()" class="p-4">
    <div x-data="{ answer: '' }">
    ...
    # Card 10: Self-assessment - Exzerpt
    {
