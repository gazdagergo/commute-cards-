...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 2: Understand why one-hot encoding is needed instead of plain numbers',
    'ml-step2',
    '<div x-data="cardResponse()" class="p-4">
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 2: Understand one-hot vector structure',
    'ml-step2',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ revealed: false, rating: null }">
        <p class="text-gray-600 text-sm mb-2">ML Fundamentals</p>
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 3: Understand dot product calculation',
    'ml-step3',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ answer: '''' }">
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 3: Understand what dot product measures',
    'ml-step3',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ revealed: false, rating: null }">
        <p class="text-gray-600 text-sm mb-2">ML Fundamentals</p>
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 4: Understand why activation functions are needed',
    'ml-step4',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ selected: null }">
        <p class="text-gray-600 text-sm mb-2">Choose the correct answer</p>
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 4: Understand ReLU activation function',
    'ml-step4',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ revealed: false, rating: null }">
        <p class="text-gray-600 text-sm mb-2">ML Fundamentals</p>
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 4: Calculate ReLU activation output',
    'ml-step4',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ answer: '''' }">
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics Step 4: Understand when to use Softmax activation',
    'ml-step4',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ selected: null }">
        <p class="text-gray-600 text-sm mb-2">Choose the correct answer</p>
...
INSERT INTO cards (semantic_description, course_task_ref, card_html, response_schema, visibility, card_type)
VALUES (
    'ML Basics: Explain the complete neuron computation formula',
    'ml-step4',
    '<div x-data="cardResponse()" class="p-4">
    <div x-data="{ answer: '''' }">
